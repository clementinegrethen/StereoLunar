...
def symmetric_inference(model, img1, img2, device):
    ...
    # compute encoder only once: on encore: 
    #Appelle _encode_image_pairs une seule fois pour calculer les caractéristiques communes (feat1, feat2) et les embeddings spatiaux (pos1, pos2) des deux images.
    feat1, feat2, pos1, pos2 = model._encode_image_pairs(img1, img2, shape1, shape2) #etape H1 et H2 du papier
    #Inférences croisées (Décodage) 
    ...
    # decoder 1-2:(res11 correspond à img1 seule, et res21 correspond à img2 vue depuis img1)
    res11, res21 = decoder(feat1, feat2, pos1, pos2, shape1, shape2)
    # decoder 2-1:(res22 pour img2 seule, res12 pour img1 vue depuis img2).
