...
if __name__ == "__main__":
    ...
    df_cam.to_csv("traj_test_nadir.csv", index=False)
    ...
    df_sun.to_csv("sun_traj_nadir.csv", index=False)
    
    # Metadata détaillée
    df_meta = pd.DataFrame(metadata)
    df_meta.to_csv("medata_traj_nadir_test.csv", index=False)
    ...
    df_summary.to_csv("test_nair_recap.csv", index=False)
