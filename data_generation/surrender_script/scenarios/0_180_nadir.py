...
TOTAL_PAIRS = 1400  # Nombre total de paires à générer

# Définir les paliers d'altitude et leur répartition
ALTITUDE_DISTRIBUTION = [
   # 10%
    {"altitude": 3500,  "pairs": 140},   # 10%
    {"altitude": 6500,  "pairs": 140},   # 10%
    {"altitude": 9500,  "pairs": 140},   # 10%
    {"altitude": 12500, "pairs": 140},   # 10%
    {"altitude": 15500, "pairs": 140},   # 10%
    {"altitude": 18500, "pairs": 140},   # 10%
    {"altitude": 21500, "pairs": 140},   # 10%
    {"altitude": 24500, "pairs": 140},   # 10%
    {"altitude": 27500, "pairs": 140},   # 10%
    {"altitude": 30500, "pairs": 140},   # 10%
   # 10%
]
...
B_H_RATIO_MIN = 0.02  # Ratio baseline/altitude minimum
B_H_RATIO_MAX = 0.1   # Ratio baseline/altitude maximum
...
if __name__ == "__main__":
    ...
    df_cam.to_csv("traj_altitude_distribution_nadir_90_180.csv", index=False)
    ...
    df_sun.to_csv("sun_traj_altitude_distribution_nadir_0_90.csv", index=False)
    
    # Metadata détaillée
    df_meta = pd.DataFrame(metadata)
    df_meta.to_csv("metadata_altitude_distribution_0_90_nadir.csv", index=False)
