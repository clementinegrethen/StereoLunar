...
ALTITUDE_DISTRIBUTION = [
    {"altitude": 3500,  "pairs": 1},   # 10%
    {"altitude": 6500,  "pairs": 1},   # 10%
    {"altitude": 9500,  "pairs": 1},   # 10%
    {"altitude": 12500, "pairs": 1},   # 10%
    {"altitude": 15500, "pairs": 1},   # 10%
    {"altitude": 18500, "pairs": 1},   # 10%
    {"altitude": 21500, "pairs": 1},   # 10%
    {"altitude": 24500, "pairs": 1},   # 10%
    {"altitude": 27500, "pairs": 1},   # 10%
...
if __name__ == "__main__":
    ...
    df_meta.to_csv("metadata_oblique_altitude_distribution_correction.csv", index=False)
    ...
    df_summary.to_csv("pair_summary_oblique_altitude_distribution_correction.csv", index=False)
