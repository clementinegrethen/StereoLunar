...
The model \href{[https://huggingface.co/cgrethen/MOONSt3R](https://huggingface.co/cgrethen/MOONSt3R)}{MOONSt3R} will be downloaded automatically when you run the demo.
